...
from config.config import THREADNUM, parserList, UPDATE_TIME, MINNUM
from db.DataStore import store_data, sqlhelper
from spider.HtmlDownloader import HtmlDownloader
from spider.HtmlPraser import HtmlParser
...
class ProxyCrawl(object):
    ...
    def run(self):
        while True:
            ...
            say = 'IPProxyPool----->>>>>>>>db exists ip:%d' % len(self.proxies)
